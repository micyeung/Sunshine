...
public class WeatherDataParser {
    ...
    public void getWeatherDataFromJson(String forecastJsonStr, int numDays, String locationSetting, Context ctx)
            throws JSONException {
        ...
        long locationID = addLocation(locationSetting, cityName, cityLatitude, cityLongitude, ctx);
